...
public class Ejecutor { 
    ...
    public static void ingresarCasa() { 
        ...
        escrituraArcPropietario.setRegistro(propietario); 
        escrituraArcPropietario.setSalida(); 
        escrituraArcPropietario.cerrarArchivo(); 
 
        EscConstructora escrituraArcConstructora 
                = new EscConstructora(arcConstructora); 
        escrituraArcConstructora.setRegistro(constructora); 
        escrituraArcConstructora.setSalida(); 
        escrituraArcConstructora.cerrarArchivo(); 
 
        EscCiudad escrituraArcCiudad 
                = new EscCiudad(arcCiudad); 
        escrituraArcCiudad.setRegistro(ciudad); 
        escrituraArcCiudad.setSalida(); 
        escrituraArcCiudad.cerrarArchivo(); 
 
        EscBarrio escrituraArcBarrio 
                = new EscBarrio(arcBarrio); 
        escrituraArcBarrio.setRegistro(barrio); 
        escrituraArcBarrio.setSalida(); 
        escrituraArcBarrio.cerrarArchivo(); 
 
        EscCasa escrituraArcCasa = new EscCasa(arcCasa); 
        escrituraArcCasa.setRegistro(casa); 
        escrituraArcCasa.setSalida(); 
    ...
    public static void ingresarDepartamento() { 
        ...
        escrituraArcDepartamento.setRegistro(departamento); 
        escrituraArcDepartamento.setSalida(); 
    ...
    public static void visualizarDepartamentos() { 
        ...
        lecturaArcDepartamento.setListaDepartamentos(); 
    ...
    public static void visualizarPropietarios() { 
        ...
        lecturaArcPropietario.setListaPropietarios(); 
    ...
    public static void visualizarPropietarioId() { 
        ...
        Propietario propietario = lecturaArcPropietario.getPropietraio(id); 
    ...
    public static void visualizarConstructoras() { 
        ...
        lecturaArcConstructora.setListaConstructoras(); 
    ...
    public static void visualizarConstructoraId() { 
        ...
        Constructora constructora = lecturaArcConstructora.getConstructora(id); 
    ...
    public static void visualizarCiudades() { 
        ...
        lecturaArcCiudad.setListaCiudades(); 
    ...
    public static void visualizarCiudadNombre() { 
        ...
        Ciudad ciudad = lecturaArcCiudad.getCiudad(nombre); 
    ...
    public static void visualizarBarrios() { 
        ...
        lecturaArcBarrio.setListaBarrios(); 
    ...
    public static void visualizarBarrioNombre() { 
        ...
        Barrio barrio = lecturaArcBarrio.getBarrio(nombre); 
